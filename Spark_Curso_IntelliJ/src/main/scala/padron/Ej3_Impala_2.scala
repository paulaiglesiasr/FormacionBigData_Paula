...
object Ej3_Impala_2 {
  def main(): Unit = {
    ...
    spark.sql("select * from datos_padron.padron_txt_2").show()
    spark.sql("select * from datos_padron.padron_parquet_2").show()
    // En SQL
